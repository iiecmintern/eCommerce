        ...
        <div className="w-full max-w-5xl grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                { icon: <Store className="h-6 w-6" />, label: "Active Stores", value: "12,847" },
                { icon: <Users className="h-6 w-6" />, label: "Happy Customers", value: "284K+" },
                { icon: <BarChart3 className="h-6 w-6" />, label: "Revenue Generated", value: "$2.8B+" },
                { icon: <Globe className="h-6 w-6" />, label: "Countries", value: "180+" }
              ].map((stat, index) => (
